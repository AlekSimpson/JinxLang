...
# For Loops
InlineForTest = Test("for i in 1:5 { 1 + 1 }", "Inline For Loops", '; ModuleID = "main"\ntarget triple = "unknown-unknown-unknown"\ntarget datalayout = ""\n\n%"Array" = type {i64*}\n%"String" = type {i8*}\ndefine void @"main"() \n{\nentry:\n  %".2" = alloca i64\n  store i64 1, i64* %".2"\n  %".4" = load i64, i64* %".2"\n  %".5" = icmp sle i64 %".4", 5\n  br i1 %".5", label %"for_loop_entry1", label %"for_loop_otherwise0"\nfor_loop_entry1:\n  %".7" = add i64 1, 1\n  %".8" = load i64, i64* %".2"\n  %".9" = icmp sle i64 %".8", 5\n  br i1 %".9", label %"for_loop_entry1", label %"for_loop_otherwise0"\nfor_loop_otherwise0:\n  ret void\n}\n\ndeclare i64 @"printf"(i8* %".1", ...) \n')
NewlineForTest = Test("for i in 1:5 {; 1 + 1; }", "Newline For Loops", '; ModuleID = "main"\ntarget triple = "unknown-unknown-unknown"\ntarget datalayout = ""\n\n%"Array" = type {i64*}\n%"String" = type {i8*}\ndefine void @"main"() \n{\nentry:\n  %".2" = alloca i64\n  store i64 1, i64* %".2"\n  %".4" = load i64, i64* %".2"\n  %".5" = icmp sle i64 %".4", 5\n  br i1 %".5", label %"for_loop_entry1", label %"for_loop_otherwise0"\nfor_loop_entry1:\n  %".7" = add i64 1, 1\n  %".8" = load i64, i64* %".2"\n  %".9" = icmp sle i64 %".8", 5\n  br i1 %".9", label %"for_loop_entry1", label %"for_loop_otherwise0"\nfor_loop_otherwise0:\n  ret void\n}\n\ndeclare i64 @"printf"(i8* %".1", ...) \n')
...
arraysPackage = [
    ArrayDec,
    ArrayRef,
    #ArrayApp, # NOTE: Implementing this later, might not implement at all?
    ArrayVarRef,
    ArrayTypeMisMatch
]
